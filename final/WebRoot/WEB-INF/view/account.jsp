...
<div class="container">
		...
		<div class="col-md-5 left-account ">
			<a href="single.html"><img class="img-responsive " src="<%=basePath %>res/images/ac.png" alt=""></a>
			<div class="five">
			<h1>25% </h1><span>discount</span>
			</div>
			<a href="/final/manager/register.html" class="create">Create an account</a>
<div class="clearfix"> </div>
		</div>
	<div class="clearfix"> </div>
	</div>
	...
	<div class="footer">
		...
		<div class="col-md-4 footer-left left-footer">
			...
			<div class="letter">
				...
				<p class="footer-class">Copyright &copy; 2015.Company God Chen All rights reserved.</a></p>
			</div>
